...
<div class="main-header">
    ...
    <p>Tác giả: Lục Thị Oanh - Trường Tiểu học Trần Phú - ĐT: 0976260133</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lục Thị Oanh - Trường Tiểu học Trần Phú- ĐT: 0976260133</div>", unsafe_allow_html=True)
